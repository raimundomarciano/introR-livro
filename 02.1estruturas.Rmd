...
```
Caso os dados não possuam ordenação especifica ou comparabilidade, geralmente recomenda-se que sejam deixados como strings "normais", ao invés de factors. Várias funções de importações incluem um comando para que você informe qual tratamento deseja (geralmente o parâmetro é _stringsAsFactors_).
