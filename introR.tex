...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{clientes}\SpecialCharTok{$}\NormalTok{cnpj}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{clientes}\SpecialCharTok{$}\NormalTok{cnpj[}\DecValTok{3}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# O data.frame contém uma coluna chamada \textquotesingle{}nome\textquotesingle{}. Veja o que acontece se, por descuido}
\CommentTok{\# pedirmos a coluna $nom (faltando o \textquotesingle{}e\textquotesingle{})}
\NormalTok{primeiroDataFrame}\SpecialCharTok{$}\NormalTok{nom}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{primeiroTibble}\SpecialCharTok{$}\NormalTok{nom}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Aconteceria o mesmo se você usasse um nome \textquotesingle{}nada a ver\textquotesingle{}}
\NormalTok{primeiroTibble}\SpecialCharTok{$}\NormalTok{valhaMeDeus}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{outroTibble }\OtherTok{\textless{}{-}} \FunctionTok{tibble}\NormalTok{(}\AttributeTok{nome =} \FunctionTok{c}\NormalTok{(}\StringTok{"raimundo"}\NormalTok{, }\StringTok{"marciano"}\NormalTok{), }\AttributeTok{nUmErOs =} \FunctionTok{c}\NormalTok{(}\DecValTok{29}\NormalTok{,}\DecValTok{12}\NormalTok{))}
\NormalTok{outroTibble}\SpecialCharTok{$}\NormalTok{nUmErOs}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{grep}\NormalTok{(}\StringTok{"Petrobras"}\NormalTok{, cias}\SpecialCharTok{$}\NormalTok{nome)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{grep}\NormalTok{(}\StringTok{"Banco do Brasil"}\NormalTok{, cias}\SpecialCharTok{$}\NormalTok{nome)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{grepl}\NormalTok{(}\StringTok{"Petrobras"}\NormalTok{, cias}\SpecialCharTok{$}\NormalTok{nome)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{grepl}\NormalTok{(}\StringTok{"Banco do Brasil"}\NormalTok{, cias}\SpecialCharTok{$}\NormalTok{nome)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# a funcao recebera o \textquotesingle{}salario\textquotesingle{}}
\NormalTok{fgts }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(salario)\{}
...
\NormalTok{  fgtsFuncionario }\OtherTok{\textless{}{-}}\NormalTok{ salario }\SpecialCharTok{*} \FloatTok{0.08}
  \CommentTok{\# vamos gerar uma frase contendo o valor do FGTS}
\NormalTok{  mensagem }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(}\StringTok{"O valor do FGTS é R$ "}\NormalTok{, fgtsFuncionario, }\StringTok{"."}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{fgts}\NormalTok{(}\DecValTok{2000}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fgtsFunc1 }\OtherTok{\textless{}{-}} \FunctionTok{fgts}\NormalTok{(}\DecValTok{2000}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{nchar}\NormalTok{(dados}\SpecialCharTok{$}\NormalTok{cnpj[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{caracteres }\OtherTok{\textless{}{-}} \FunctionTok{nchar}\NormalTok{(dados}\SpecialCharTok{$}\NormalTok{cnpj)}
\FunctionTok{table}\NormalTok{(caracteres)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{zeros }\OtherTok{\textless{}{-}} \ConstantTok{NA}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(dados))\{}
\NormalTok{  numeroZeros }\OtherTok{\textless{}{-}} \DecValTok{14} \SpecialCharTok{{-}} \FunctionTok{nchar}\NormalTok{(dados}\SpecialCharTok{$}\NormalTok{cnpj[i])}
  \ControlFlowTok{if}\NormalTok{(numeroZeros }\SpecialCharTok{==} \DecValTok{0}\NormalTok{)\{}
    \ControlFlowTok{next}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{  zeros }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(}\StringTok{"0"}\NormalTok{, numeroZeros)}
\NormalTok{  zeros }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(zeros, }\AttributeTok{collapse =} \StringTok{""}\NormalTok{)}
\NormalTok{  dados}\SpecialCharTok{$}\NormalTok{cnpj[i] }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(zeros, dados}\SpecialCharTok{$}\NormalTok{cnpj[i], }\AttributeTok{collapse =} \StringTok{""}\NormalTok{)}
\NormalTok{  \}}
\NormalTok{\}}
