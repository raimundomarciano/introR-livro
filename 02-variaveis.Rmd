...
Por padrão, o R trata números como variáveis da classe _numeric_ e tipo _double_. Em outras palavras, ele considera, por padrão, qualquer número digitado como um número real. 
...
Geralmente, isso é o comportamento desejado. No caso de você precisar que o R trate o número como um _inteiro_, você deve acrescentar um L.
